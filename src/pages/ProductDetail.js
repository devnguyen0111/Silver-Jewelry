          ...
          <div className="tab-content">
            {activeTab === 'description' && (
              <div className="tab-panel">
                ...
                <p>{product.description}</p>
                <p>
                  Sản phẩm được chế tác từ bạc cao cấp với quy trình kiểm định nghiêm ngặt. 
                  Mỗi món trang sức đều được chăm sóc tỉ mỉ để đảm bảo chất lượng tốt nhất 
                  cho khách hàng.
                </p>
                <p>
                  Chúng tôi cam kết mang đến những sản phẩm trang sức bạc đẹp nhất, 
                  chất lượng cao nhất với giá cả hợp lý nhất thị trường.
                </p>
              </div>
            )}
                ...
                <div className="sample-reviews">
                  <div className="review-item">
                    ...
                    <p className="review-text">
                      "Sản phẩm rất đẹp, chất lượng tốt. Tôi rất hài lòng với món trang sức này!"
                    </p>
